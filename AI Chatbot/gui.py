...
# Menu bar
    ...
    # Options
       ...
       # color_theme.add_command(label="Night",command=self.) 
        ...
        color_theme.add_command(label="Monokai",command=self.color_theme_hacker)
    ...
    def msg(self):
        tkinter.messagebox.showinfo("PyBOT v1.0",'PyBOT is an intelligent chatbot designed to assist users with their frequently asked questions (FAQs) about Cloud Counselage Pvt Ltd. It is a conversational AI system built using Python and Natural Language Processing (NLP) techniques, making it capable of understanding and responding to user queries in a natural and human-like way.')

    def about(self):
        tkinter.messagebox.showinfo("PyBOT Developer","PyBOT has been developed by Amina Shaikh, a student of Bharati Vidyapeeth's College of Engineering for Women, Pune.")
